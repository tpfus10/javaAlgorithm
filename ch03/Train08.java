...
public class Train08 {
	static final Comparator<PhyscData3> HEIGHT_ORDER = new CompHeight();//p125 1번
	static final Comparator<PhyscData3> NAME_ORDER = new CompName();//p125 1번
	...
	public static void main(String[] args) {
		...
		Arrays.binarySearch(data, key, NAME_ORDER);
